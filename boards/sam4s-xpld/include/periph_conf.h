...
/**
 * @ingroup     boards_sam4s-xplained
 * @{
 *
 * @file
 * @brief       Peripheral MCU configuration for the Atmel SAM4S Xplained board
 *
...
#define UART_0_CLKEN()      (PMC->PMC_PCER0 |= (1 << ID_UART0))
#define UART_0_CLKDIS()     (PMC->PMC_PCER0 &= ~(1 << ID_UART0))
...
#define UART_1_CLKEN()      (PMC->PMC_PCER0 |= (1 << ID_UART1))
#define UART_1_CLKDIS()     (PMC->PMC_PCER0 &= ~(1 << ID_UART1))
#define UART_1_IRQ          UART1_IRQn
#define UART_1_ISR          isr_uart1
/* UART 1 pin configuration */
#define UART_1_PORT         PIOB
#define UART_1_PINS         (PIO_PB2 | PIO_PB3)
